...
public class InstuctionsAdapter extends RecyclerView.Adapter<InstructionsViewHolder>{

    Context context;
    List<InstuctionResponse> list;

    public InstuctionsAdapter(Context context, List<InstuctionResponse> list) {
